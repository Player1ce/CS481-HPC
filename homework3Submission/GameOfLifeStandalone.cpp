...
Name: Marcelo Torres
    ...
    To Run: Run ./Homework3 in the homework4Submission directory. Use `./Homework3 <board_size> <max_iterations> <num_threads> <output_directory(absolute or relative)> <test_file>`
*/
