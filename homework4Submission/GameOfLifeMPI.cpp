/*
    ...
    To Run: Run ./Homework4 in the homework4Submission directory. Use `./Homework3 <board_size> <max_iterations> <num_processes> <output_directory(absolute or relative)> <test_file>`
*/
